                                ...
                                <li class="card">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="card-footer">
                                            <a href="{{route('actividades.detalle',$actividad->actividad)}}" class="button ">Detalle</a>
                                            <a href="#" class="button ">Estadio</a>
                                            <a href="{{route('usuario.inscripcion',$actividad->actividad)}}" class="button ">Inscribirse</a>
                                        </div>
                                </li>
                            @endforeach
                        </ul>
