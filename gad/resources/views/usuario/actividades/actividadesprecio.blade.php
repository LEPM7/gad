        ...
        <div class="pages">
            ...
            <div data-page="index" class="page navbar-fixed">
                ...
                <div class="page-content login-screen-content">
                    <div class="login-screen-title">Ingrese el precio maximo</div>
                    <!-- Login form -->
                    {!! Form::open(['route' => 'usuario.actividades.preciomaximo', 'method' => 'POST']) !!}
                            <!-- Login form -->
                            ...
                            <li>
                                <div class="item-content">
                                    <div class="item-inner">
                                        {!! Form::label('precio','Precio Maximo:',['class' => 'item-title label']) !!}
                                        <div class="item-input">
                                            {!! Form::number('precio', null, ['placeholder' => 'Precio Maximo:', 'step' => '0.01', 'required']) !!}
                                        </div>
                                    </div>
                                </div>
                            </li>
                    ...
                    <div class="list-block">
                        <ul>
                            <li>
                                {!! Form::submit('Continuar ->', ['class' => 'button button-fill button-big']) !!}
                            </li>
                        </ul>
                    </div>
                    {!! Form::close() !!}
